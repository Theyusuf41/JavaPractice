...
public class C02_Encapsulation { // Pojo class
    // private fieldlar yazilir
     String name ="tugba hanim";
    private int id = 1001;

    private String mail = "qa@example.com";

    public C02_Encapsulation(String name, int id, String mail) { // full p'li const
        this.name = name;
        this.id = id;
        this.mail = mail;
    }

    public C02_Encapsulation() { // ici bos constructor
    }

    public String getMail(){ // private variable return eden method
        return mail;
    }

    public int getId(){ // private variable return eden method
        return id;
    }
